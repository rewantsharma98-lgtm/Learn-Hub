        ...
        >
          ...
          <div className="flex items-center justify-center gap-8 py-8">
             <div className="flex flex-col gap-1">
                <span className="text-xl font-bold text-white tracking-tighter">50+</span>
                <span className="text-[9px] uppercase tracking-widest text-white/20 font-bold">Courses</span>
             </div>
             <div className="w-[1px] h-8 bg-white/5" />
             <div className="flex flex-col gap-1">
                <span className="text-xl font-bold text-white tracking-tighter">1.2k+</span>
                <span className="text-[9px] uppercase tracking-widest text-white/20 font-bold">Students</span>
             </div>
             <div className="w-[1px] h-8 bg-white/5" />
             <div className="flex flex-col gap-1">
                <span className="text-xl font-bold text-white tracking-tighter">24/7</span>
                <span className="text-[9px] uppercase tracking-widest text-white/20 font-bold">Support</span>
             </div>
          </div>
        </motion.div>
            ...
            <div className="flex flex-col md:flex-row">
               ...
               <div className="w-full md:w-16 border-b md:border-b-0 md:border-r border-white/[0.05] bg-white/[0.01] flex md:flex-col items-center py-2 md:py-8 gap-5 md:gap-8 justify-center md:justify-start px-4 md:px-0">
                  {[Layout, TerminalIcon, Users, Globe].map((Icon, i) => (
                    <Icon 
                      key={i} 
                      onClick={() => i === 1 && setActiveTab("terminal")}
                      className={`w-4 h-4 md:w-5 md:h-5 ${i === 0 && activeTab === 'overview' ? 'text-primary' : i === 1 && activeTab === 'terminal' ? 'text-primary' : 'text-white/10 hover:text-white/30'} transition-colors cursor-pointer`} 
                    />
                  ))}
               </div>
